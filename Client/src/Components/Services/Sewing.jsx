...
const SewingDetails = () => {
    ...
    const mensItems = [
        { name: "Patching Holes", price: 30 },
        { name: "Zipper Repair or Replacement", price: 20 },
        { name: "Pocket Repairs", price: 40 },
        { name: "Sewing Jackets", price: 400 },
        { name: "Sewing pants", price: 300 },
        { name: "Sewing Shirt", price: 250 },
    ];

    const womensItems = [
        { name: "Zipper Repair", price: 20 },
        { name: "Pocket Repair", price: 40 },
        { name: "Sewing Jacket", price: 40 },
        { name: "Sewing pant", price: 300 },
        { name: "Sewing Suit", price: 450 },
        { name: "Sewing plazo", price: 150 },
    ];
    ...
    return (
        <div className="sewing-details flex flex-col md:flex-row p-8 bg-gray-50">
            ...
            <div className="flex-grow mb-8 md:mb-0 md:mr-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-6">Alteration Service</h1>

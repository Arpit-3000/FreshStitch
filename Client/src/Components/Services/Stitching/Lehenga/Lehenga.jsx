    ...
    return (
        <>
            <div className="bg-creamLight min-h-screen">
                ...
                >
                    <img src={lehengaBg} className="h-full object-cover" alt="Lehenga Background" />
                    <h1 className="absolute inset-0 flex top-20 left-2/4 text-5xl font-bold text-amber-400 ">Lehenga Designs</h1>
                    <h6 className="absolute inset-0 flex top-40 left-2/4 text-2xl font-bold text-amber-400 ">Get your lehenga, where every stitch speaks elegance.</h6>
                </div>
